...
function TipoResultado(_tipo1,_tipo2){
    if((_tipo1 === TIPO_DATO.DECIMAL && _tipo2=== TIPO_DATO.DECIMAL)||(_tipo1 === TIPO_DATO.ENTERO && _tipo2=== TIPO_DATO.DECIMAL)||(_tipo1 === TIPO_DATO.UNARIO && _tipo2=== TIPO_DATO.DECIMAL)
    ...
    else if((_tipo1 === TIPO_DATO.ENTERO && _tipo2=== TIPO_DATO.ENTERO)||(_tipo1 === TIPO_DATO.ENTERO && _tipo2=== TIPO_DATO.BOOL)||(_tipo1 === TIPO_DATO.UNARIO && _tipo2=== TIPO_DATO.ENTERO)||
